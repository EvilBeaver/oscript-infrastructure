...
server {
    ...
    location / {
        ...
        set $target_url http://minio:9000;
    ...
    ssl_certificate /etc/letsencrypt/live/s3.oscript.io/fullchain.pem;
    ssl_certificate_key /etc/letsencrypt/live/s3.oscript.io/privkey.pem;
}
